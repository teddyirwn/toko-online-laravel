   <div class="col-xl-6 col-lg-7 text-center">
       <nav class="navbar navbar-expand-md navbar-custom bg-light shadow-sm py-3 fixed-top">
           <div class="container">

               <a class="navbar-brand" href="{{ url('/') }}">
                   <i class="fa-solid fa-shop  fa-lg text-primary">
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                   ...
                   <ul class="navbar-nav ms-auto">
                       ...
                       <li class="nav-item">
                           <a class="nav-link" href="{{ route('categoryall') }} ">kategori</a>
                       </li>
                       <li class="nav-item">
                       ...
                       @else
                           <li class="nav-item dropdown">
                               ...
                               <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                   <li>
                                       <a class="dropdown-item" href="{{ route('order-product') }} "> My Order</a>
                                   </li>
                                   <li>
                   ...
                   <form action="{{ url('searchproduct') }} " method="POST" class="d-flex">
                       @csrf
                       <input class="form-control me-2" type="search" name="product_name" id="kata"
                   ...
                   <a id="header-cart "
                       ...
                       <span class="badge badge-pill bg-danger cart-count" id="cart-count">0</span>
                   </a>
